...
export function WeatherCard({ w, compact = false }: { w: Weather; compact?: boolean }) {
  return (
    <div className="card-soft overflow-hidden">
      ...
      <div className={`grid gap-px bg-line ${compact ? "grid-cols-3" : "grid-cols-2 sm:grid-cols-3 lg:grid-cols-5"}`}>
